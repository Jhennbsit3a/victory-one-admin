  ...
  data() {
    return {
      ...
      items: [
        ...
        { icon: 'mdi-account', title: 'Account Management', to: '/admin/accounts',},
        { icon: 'mdi-cube', title: 'Product Management', to: '/admin/products',},
        { icon: 'mdi-order-bool-ascending', title: 'Order Management', to: '/admin/orders',},
        { icon: 'mdi-currency-php', title: 'Price Management', to: '/admin/price',},
        { icon: 'mdi-folder', title: 'Category Management', to: '/admin/category',},
        { icon: 'mdi-warehouse', title: 'Inventory Management', to: '/admin/inventory',},
